...
r=validate_and_rate(fits,truth,draw,rng,150,'CC',SIGNED_AMPS)
np.savez('/home/claude/sign_cc.npz',**{str(k):v for k,v in r.items()})
print("CC signed:",{k:round(v) for k,v in r.items()})

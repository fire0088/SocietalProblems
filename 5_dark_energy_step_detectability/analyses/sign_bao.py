...
r=validate_and_rate(fits,truth,draw,rng,400,'BAO',SIGNED_AMPS)
np.savez('/home/claude/sign_bao.npz',**{str(k):v for k,v in r.items()})
print("BAO signed:",{k:round(v) for k,v in r.items()})

...
r=validate_and_rate(fits,truth,draw,rng,400,'SNe',SIGNED_AMPS)
np.savez('/home/claude/sign_sne.npz',**{str(k):v for k,v in r.items()})
print("SNe signed:",{k:round(v) for k,v in r.items()})
